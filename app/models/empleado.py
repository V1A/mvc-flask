...
class Empleados:
    def __init__(self):
        ...
        self.nuevoEmpleado(nombre="Renata Martinez", cedula="1234001456", salario=1200)
    ...
    def sumarSalario(self):
        return reduce(lambda a, b: a + b, map(lambda empleado: empleado.salario, self.empleados))
